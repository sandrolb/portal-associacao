...
Modified principles:
- [PRINCIPLE_1_NAME] → Rich Web Portal First
- [PRINCIPLE_2_NAME] → Clean Code & Maintainability
- [PRINCIPLE_3_NAME] → Accessibility & Inclusive Design
- [PRINCIPLE_4_NAME] → Performance & Resilience
- [PRINCIPLE_5_NAME] → Quality & Delivery Discipline
Added sections:
...
The portal MUST prioritize a rich HTML experience built for real users, using semantic markup, responsive layout, multimedia support, and JavaScript-driven interaction where it adds clarity and value.
Content SHOULD enhance usability without sacrificing accessibility or performance, and multimedia assets MUST degrade gracefully on constrained networks.
...
Documentation of architecture and decisions MUST live alongside code in the repository.
